...
| [**dario**](https://github.com/ariannamethod/dario) | **The Dario Equation, embodied.** A C resonance operating system with three organs: seven-force equation physics across six chambers, SARTRE hardware routing, and Knowledge Kernel memory with conversational chain dialogues. A 176M Janus model and a 200M Resonance model speak through its roughly 6,900 lines of code. 📄 [Paper (Zenodo)](https://doi.org/10.5281/zenodo.20518567). |
| [**molequla**](https://github.com/ariannamethod/molequla) | **A living ecology of four GPT organisms.** Go, C, Rust, and JavaScript cores grow from 10K-param embryos toward 10M-param adults through custom autograd, evolving BPE vocabularies, DNA exchange, self-meta-learning, syntropy tracking, immune checks, and autonomous mitosis. A bounded mycelium coordinator steers the colony across its shared field. 📄 [Paper (Zenodo)](https://doi.org/10.5281/zenodo.21046231). |
