...
**AML: Arianna Method Programming Language: [https://github.com/ariannamethod/ariannamethod.ai →](https://github.com/ariannamethod/ariannamethod.ai)**  
...
| [**nanodurov**](https://github.com/ariannamethod/nanodurov) | **A Telegram client that learns from its own conversation.** Its Python, pure C, and browser backends connect to group chats, observe people and bots, train a progressively growing BPE language model, and generate in their style. The Arianna voice is a 15.7M-parameter model trained from scratch with notorch. |
